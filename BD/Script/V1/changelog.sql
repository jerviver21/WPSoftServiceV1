...
ALTER TABLE certificados_cursos ADD CONSTRAINT certificados_cursos_pk PRIMARY KEY(id);
ALTER TABLE certificados_cursos ADD id_empleado bigint;
CREATE TABLE tipo_certificado (
	id int4 NOT NULL,
	nombre varchar(500) NOT NULL
);
ALTER TABLE tipo_certificado ADD CONSTRAINT tipo_certificado PRIMARY KEY(id);
ALTER TABLE certificados_cursos RENAME TO certificados;
ALTER TABLE certificados ADD CONSTRAINT empleado_certificacion_fk FOREIGN KEY (id_empleado) REFERENCES empleados(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE certificados ADD CONSTRAINT certificado_tipo_fk FOREIGN KEY (id_empleado) REFERENCES tipo_certificado(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
ALTER TABLE certificados DROP CONSTRAINT certificado_tipo_fk;
ALTER TABLE certificados ADD CONSTRAINT certificado_tipo_fk FOREIGN KEY (id_tipo) REFERENCES tipo_certificado(id) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE certificados RENAME TO certificados_emp;
ALTER TABLE tipo_certificado RENAME TO tipo_certificado_emp;
ALTER TABLE tipo_certificado_emp DROP CONSTRAINT tipo_certificado;
ALTER TABLE tipo_certificado_emp ADD CONSTRAINT tipo_certificado_pk PRIMARY KEY(id);
...
ALTER TABLE empleados DROP COLUMN otros;
ALTER TABLE empleados DROP COLUMN trabajo_alturas;
